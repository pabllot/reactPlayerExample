...
const Video = ({isTheaterMode, setIsTheaterMode, chosenVideo}) => {
 ...
 const  handleRange= (e)=>{
    ...
    else if(e.target.value > 0.1 && e.target.value < 0.3) vidRef.current.volume = 0.2, setIsMute(true)
    else if(e.target.value > 0.3 && e.target.value < 0.6) vidRef.current.volume = 0.7, setIsMute(true)
